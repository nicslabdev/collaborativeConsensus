...
plt.plot(x_PNSA, y_PNSA, label="PNSAnomaly")

x_PPSA = np.arange(1, 100, 100/len(y_PPSA))
plt.plot(x_PPSA, y_PPSA, label="PPSAnomaly")

plt.xticks([0, 20, 40, 60, 80, 100])

plt.xlabel("Battery (SoC)")
plt.ylabel("Charge Power (kW)")
plt.title("Volkswagen ID.4 1st (126 kW)")
plt.legend()

#plt.show()
plt.savefig("PSAnomaly_Figure_VWID4.png")