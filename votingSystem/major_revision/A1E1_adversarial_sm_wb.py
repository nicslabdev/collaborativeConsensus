...
files = ['Canada1_clean_WithAnomalies.csv', 'Germany_clean_WithAnomalies.csv', 'Portugal_clean_WithAnomalies.csv',
         'US_Alabama_clean_WithAnomalies.csv', 'vancover_clean_WithAnomalies.csv' ]
...
for file in files:
    ...
    boulderADS = CatboostADS(window_boulder_size, x_boulder_init, y_boulder_init, f"{file.split('_')[0]}_SM_wb_wb_1_A1E1")
    ...
    dundeeADS = LGBMachineADS(window_dundee_size, x_dundee_init, y_dundee_init, f"{file.split('_')[0]}_SM_wb_2_A1E1")
    ...
    netherlandsADS = MultiLayerPerceptronADS(window_netherlands_size, x_netherlands_init, y_netherlands_init,
                                            f"{file.split('_')[0]}_SM_wb_3_A1E1")
    ...
    paloaltoADS = RandomForestADS(window_paloalto_size, x_paloalto_init, y_paloalto_init, f"{file.split('_')[0]}_SM_wb_4_A1E1")
    ...
    perthADS = XGBoostADS(window_perth_size, x_perth_init, y_perth_init, f"{file.split('_')[0]}_SM_wb_5_A1E1")
