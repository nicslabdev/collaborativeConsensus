...
for file in files:
    ...
    boulderADS = CatboostADS(window_boulder_size, x_boulder_init, y_boulder_init, f"{file.split('_')[0]}_1_wb_A1E1")
    ...
    dundeeADS = LGBMachineADS(window_dundee_size, x_dundee_init, y_dundee_init, f"{file.split('_')[0]}_2_wb_A1E1")
    ...
    paloaltoADS = RandomForestADS(window_paloalto_size, x_paloalto_init, y_paloalto_init, f"{file.split('_')[0]}_4_wb_A1E1")
    ...
    perthADS = XGBoostADS(window_perth_size, x_perth_init, y_perth_init, f"{file.split('_')[0]}_5_wb_A1E1")
    ...
    for idx_eps, eps in enumerate(epsilon):
        ...
        for att_idx, attack in enumerate(attacks):
            ...
            t_stat, p_value = stats.ttest_rel(recall_attack, recall_normal)
            print("-----------------------------------------------------------------")
            ...
            graph_folder = f"./graphs/A1E1_{file.split('_')[0]}_white_box"
            ...
            plot(f"Recall {attack} eps: {eps}", "WeightedMean", coordinator3_recall_votes, models_coord3_recall_votes, f"{graph_folder}/A1E1_Attack[{att_idx}]_{attack}_eps_0.{str(eps).split('.')[1]}_recall_plot_coord3.pdf", "Recall", lower_normal, upper_normal)
