...
boulderADS = CatboostADS(window_boulder_size, x_boulder_init, y_boulder_init, "BoulderADS_sm_wb_A2E1")
...
dundeeADS = LGBMachineADS(window_dundee_size, x_dundee_init, y_dundee_init, "DundeeADS_sm_wb_A2E1")
...
paloaltoADS = RandomForestADS(window_paloalto_size, x_paloalto_init, y_paloalto_init, "PaloAltoADS_sm_wb_A2E1")
...
perthADS = XGBoostADS(window_perth_size, x_perth_init, y_perth_init, "PerthADS_sm_wb_A2E1")
